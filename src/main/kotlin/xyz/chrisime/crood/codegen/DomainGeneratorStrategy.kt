...
open class DomainGeneratorStrategy : DefaultGeneratorStrategy() {
    ...
    override fun getFileHeader(definition: Definition, mode: GeneratorStrategy.Mode) = header(definition)

    override fun getGlobalReferencesFileHeader(definition: Definition, objectType: Class<out Definition>) = header(definition)

    private companion object {
        private const val DOMAIN = "Domain"

        private val header: (Definition) -> String = { definition ->
            "This domain class generated by CRooD. It corresponds to '${definition.name}' in your schema '${definition.schema}'."
        }
    }
